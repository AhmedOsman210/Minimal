        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/products/1" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Product One</Link></li>
                <li><Link to="/products/2" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Product Two</Link></li>
                <li><Link to="/products/3" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Product Three</Link></li>
              </ul>
            </div>
            <div>
